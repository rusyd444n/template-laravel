                           ...
                           <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                 <div class="tp-slide-item">
                                    <div class="tp-slide-item__content">
                                       <h4 class="tp-slide-item__sub-title">Accessories</h4>
                                       <h3 class="tp-slide-item__title mb-25">Up To <i>35% Off <img src="{{asset('front/assets/img/icon/title-shape-02.jpg')}}" alt=""></i> latest Creations</h3>
                                       <a class="tp-slide-item__slide-btn tp-btn" href="shop.html">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                    <div class="tp-slide-item__img">
                              ...
                              <div class="swiper-slide">
                                 <div class="tp-slide-item">
                                    <div class="tp-slide-item__content">
                                       <h4 class="tp-slide-item__sub-title">Accessories</h4>
                                       <h3 class="tp-slide-item__title mb-25">Up To <i>45% Off <img src="{{asset('front/assets/img/icon/title-shape-02.jpg')}}" alt=""></i> latest Creations</h3>
                                       <a class="tp-slide-item__slide-btn tp-btn" href="shop.html">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                    <div class="tp-slide-item__img">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="tpsection mb-40">
                        <h4 class="tpsection__title">Top <span> Categories <img src="{{asset('front/assets/img/icon/title-shape-01.jpg')}}" alt=""></span></h4>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 col-12">
                     <div class="tpsection mb-40">
                        <h4 class="tpsection__title">Popular <span> Products <img src="{{asset('front/assets/img/icon/title-shape-01.jpg')}}" alt=""></span></h4>
                     </div>
                  </div>
                  <div class="col-md-6 col-12">
                     <div class="tpnavbar">
                     ...
                     <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="col">
                           <div class="tpproduct pb-15 mb-30">
                              <div class="tpproduct__thumb p-relative">
                                 <a href="shop-details-2.html">
                                    <img src="{{asset('front/assets/img/product/home-one/product-13.jpg')}}" alt="product-thumb">
                                    <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-14.jpg')}}" alt="">
                                 </a>
                                 <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                        ...
                        <div class="col">
                           <div class="tpproduct pb-15 mb-30">
                              <div class="tpproduct__thumb p-relative">
                                 <a href="shop-details-2.html">
                                    <img src="{{asset('front/assets/img/product/home-one/product-15.jpg')}}" alt="product-thumb">
                                    <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-16.jpg')}}" alt="">
                                 </a>
                                 <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                        ...
                        <div class="col">
                           <div class="tpproduct pb-15 mb-30">
                              <div class="tpproduct__thumb p-relative">
                                 <a href="shop-details-2.html">
                                    <img src="{{asset('front/assets/img/product/home-one/product-17.jpg')}}" alt="product-thumb">
                                    <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-18.jpg')}}" alt="">
                                 </a>
                                 <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                        ...
                        <div class="col">
                           <div class="tpproduct pb-15 mb-30">
                              <div class="tpproduct__thumb p-relative">
                                 <a href="shop-details-2.html">
                                    <img src="{{asset('front/assets/img/product/home-one/product-19.jpg')}}" alt="product-thumb">
                                    <img class="product-thumb-secondary" src="{{asset('front/assets/img/product/home-one/product-20.jpg')}}" alt="">
                                 </a>
                                 <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
